...
from app.routes import blogcreate_router, helloworld_router, checkurl_router
...
app.include_router(blogcreate_router.router, prefix='/blogcreate', tags=['blogcreate'])
app.include_router(checkurl_router.router, prefix='/checkurl', tags=['checkurl'])
